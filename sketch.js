...
function preload(){
  ...
  bgImg1 = loadImage("Merged_document (1).jpg");
  levelImg = loadImage("bg3.jpg");
  ...
  bubblesImg = loadImage("giphy-unscreen.gif");
  ...
  oneImg = loadImage("grass1.png");
  twoImg = loadImage("grass2.png");
  shellImg = loadImage("shell_01.png");
  ...
  background1Img = loadImage("movingbg.jpg");
  objImg1 = loadImage("obj1.gif");
  objImg2 = loadImage("urchin.gif");
  objImg3 = loadImage("crab.gif");
  objImg4 = loadImage("octopus.gif");
  objImg5 = loadImage("shark.gif");
  objImg6 = loadImage("angryfish.gif");
...
shell = createSprite(width/3,height-50,200,200);
shell.addImage(shellImg);
shell.scale=0.25; 
shell.visible =false; 

fish = createSprite(width/2,height/2,200,200);
fish.addAnimation("static",fishImg1);
fish.addAnimation("dynamic",fishImg2);
fish.scale=1; 
fish.visible =false; 
...
fish.x = width/2;
fish.y = height/2;
fish.changeAnimation("static",fishImg1);
  ...
  diamonds1 = false;
   ...
   if(mousePressedOver(level1)&&l1==="locked"&&(l51==="closed"))
    ...
    if(gameState===LEVEL1){
      ...
      fish.changeAnimation("dynamic",fishImg2);
      fish.y = World.mouseY;
